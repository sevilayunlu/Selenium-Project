...
public class T7_T8_T9_POM_Practices {
    ...
    @Test
    public void t7_filed_required_error_message_test(){
    ...
    public void t8_email_format_error_message_test(){
        ...
        Assert.assertTrue(loginPage.enter_ValidEmailErrorMessage.isDisplayed());
    ...
    public void t9_wrong_email_or_password_error_message(){
        ...
        loginPage.emailInput.sendKeys("username@domain.com");
